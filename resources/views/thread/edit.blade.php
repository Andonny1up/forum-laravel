        ...
        <div class="rounded-md bg-gradient-to-r from-slate-800 to-slate-900 mb-4">
            <div class="p-4">
                ...
                <form action="{{route('threads.update',$thread)}}" method="POST">
                    ...
                    @include('thread.form')
                    <input type="submit" value="Editar pregunta" class="w-full py-4 bg-gradient-to-r from-blue-700 to-blue-700
                    hover:to-blue-600 text-white/90 font-bold text-xs rounded-md">
                </form>
            </div>
        </div>
    </div>
